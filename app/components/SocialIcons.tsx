...
import { FaEnvelope, FaInstagram, FaLinkedin, FaTiktok, FaXTwitter, FaYoutube } from "react-icons/fa6"
...
export default function SocialIcons({ className }: { className?: string }) {
	...
	return (
		<div className={classNames("grid grid-cols-3 space-x-0 md:flex md:flex-row", className)}>
			<Link href="https://x.com/defgames" target="_blank" className="group p-2">
